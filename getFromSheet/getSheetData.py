...
# 스프레드시트 URL(배열 형태로 KDT, non-KDT 출석부 url 획득)
spreadsheet_urls = private_json['spreadsheet_url']
...
def merge_json(file_path, sheet_titles):
    ...
    # JSON 파일로 저장
    with open(file_path + "StudyTime.json", 'w', encoding='utf-8') as file:
